  ...
  return (
    <>
      <Link to="/" style={{textDecoration: "none"}}>
        <Button style={{display: "flex", marginLeft: "auto", marginRight: "auto", marginTop: "20px"}} color="primary" variant="contained"
        onClick={()=>{ setIsLoggedIn(localStorage.getItem("authToken") !== null);}}
        >Home</Button>
      </Link>
      <Switch>
        <Route path="/register">
